...
public class Question5_LeastSignificantDigitFirst_RecursiveApproach {
	public static void main(String[] args) {
		Node result1 = Question5_LeastSignificantDigitFirst_RecursiveApproach.addLists(scenario1_list1(), scenario1_list2());
		LinkedListUtil.print(result1);
		
		Node result2 = Question5_LeastSignificantDigitFirst_RecursiveApproach.addLists(scenario1_list2(), scenario1_list1());
		LinkedListUtil.print(result2);
		
		Node result3 = Question5_LeastSignificantDigitFirst_RecursiveApproach.addLists(scenario2_list1(), scenario2_list2());
		LinkedListUtil.print(result3);
		
		Node result4 = Question5_LeastSignificantDigitFirst_RecursiveApproach.addLists(scenario2_list2(), scenario2_list1());
		LinkedListUtil.print(result4);
		
		Node result5 = Question5_LeastSignificantDigitFirst_RecursiveApproach.addLists(scenario1_list1(), null);
		LinkedListUtil.print(result5);
		
		Node result6 = Question5_LeastSignificantDigitFirst_RecursiveApproach.addLists(null, scenario1_list1());
		LinkedListUtil.print(result6);
		
		Node result7 = Question5_LeastSignificantDigitFirst_RecursiveApproach.addLists(null, null);
	...
	public static Node addLists(Node list1, Node list2, int carry) {
		...
		Node next = Question5_LeastSignificantDigitFirst_RecursiveApproach.addLists(list1, list2, carry);
		current.next = next;
